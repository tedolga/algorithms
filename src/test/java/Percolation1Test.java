...
public class Percolation1Test {
    private Percolation1 percolation;

    @Test
    public void testInitiation() {
        try {
            percolation = new Percolation1(0);
            Assert.assertTrue(false);
        } catch (IllegalArgumentException iae) {
            Assert.assertTrue(true);
        }
        try {
            percolation = new Percolation1(-1);
            Assert.assertTrue(false);
        } catch (IllegalArgumentException iae) {
            Assert.assertTrue(true);
        }
        percolation = new Percolation1(4722);
        try {
            percolation = new Percolation1(46341);
            Assert.assertTrue(false);
        } catch (IllegalArgumentException iae) {
    ...
    public void testOpen() throws Exception {
        percolation = new Percolation1(4);
    ...
    public void testIsOpen() {
        percolation = new Percolation1(5);
        checkIsOpenFail(0, 2);
        checkIsOpenFail(6, 2);
        checkIsOpenFail(2, 0);
        checkIsOpenFail(2, 6);
